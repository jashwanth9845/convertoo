  ...
  const handleClick = () => {
    ...
    if (openDIv) {
      if (openDIv.style.width === '0px') {
        ...
        document.getElementById('mainDIv').style.borderBottomRightRadius = '0px';
        ...
        document.getElementById('mainDIv').style.borderBottomRightRadius = '5px';
    ...
    <div style={uploaderLabel}>
      ...
      >
        <label
          ...
          onMouseEnter={(e) => {
            ...
            ${color ? color + '40' : 'rgba(0, 0, 0, 0.3)'} 0px 18px 36px -18px inset`;
          }}
          onMouseLeave={(e) => {
      ...
      <div
        ...
        style={{
          ...
          borderBottomLeftRadius: ' 5px',
          borderBottomRightRadius: '5px',
          boxShadow: `${bgColor ? bgColor + '8f' : '#3a5fc78f'} 0px 5px 10px 0px`,
          transition: 'none',
        }}
      >
        <div
